...
module.exports.ROOMS = {
    ...
    dBsBar: {
        ...
        areaColors: {
            //h will be replaced by #
            hff00ff: { cmd: "text", room: "dBsZaal", label: "Zaal", point: [94, 64], enterPoint: [234, 136], txt: "Voor alle dBs merchandise", obstacle: false },
            h00ff00: { cmd: "changearearole", url: "https://shop.dbstudio.nl/", label: "dBs Shop", txt: "Voor alle dBs merchandise, of zo een heerlijk drankje!\n\nKlik of Tik op dit bericht om de winkel te bezoeken.", align: "center", lines: 5, point: [179,70] },
