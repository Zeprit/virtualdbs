...
module.exports.ROOMS = {
    ...
    dBsBar: {
        ...
        areaColors: {
            ...
            hffff00: { cmd: "enter", room: "dBsLobby", label: "Lobby", point: [156, 6], enterPoint: [156, 178], obstacle: false },
    ...
    dBsLobby: {
        ...
        areaColors: {
            //h will be replaced by #
            hffff00: { cmd: "enter", room: "dBsBar", label: "Bar", point: [158, 190], enterPoint: [158, 23], obstacle: false },
        },
        things: {
